...
export const viennaDistricts: Record<string, DistrictInfo> = {
  '1010-wien-innere-stadt': {
    ...
    whyChooseUs: [
      ...
      'Diskrete Arbeit in gehobenen Wohnlagen',
      'Zugang zu engen Altstadtgassen',
      'Flexible Terminvereinbarung für Geschäftskunden',
      'Professionelle Abwicklung bei Geschäftsauflösungen',
    ],
    faq: [
      {
        question: 'Können Sie auch in denkmalgeschützten Gebäuden entrümpeln?',
        answer: 'Ja, wir haben umfangreiche Erfahrung mit denkmalgeschützten Altbauten in der Inneren Stadt und arbeiten besonders sorgfältig.',
      },
      {
        question: 'Wie lange dauert eine Entrümpelung im 1. Bezirk?',
        answer: 'Je nach Umfang dauert eine Wohnungsentrümpelung 4-8 Stunden. Wir arbeiten effizient und diskret.',
      },
      {
        question: 'Gibt es Zufahrtsbeschränkungen in der Altstadt?',
        answer: 'Wir kennen alle Zufahrtsmöglichkeiten und organisieren bei Bedarf Sondergenehmigungen für die Fußgängerzone.',
      },
    ],
  },
  '1020-wien-leopoldstadt': {
    ...
    whyChooseUs: [
      'Schnelle Erreichbarkeit vom Praterstern',
      'Erfahrung mit großen Objekten',
      'Flexible Arbeitszeiten für Gewerbeobjekte',
      'Effiziente Abwicklung bei Neubauprojekten',
      'Entsorgung großer Mengen möglich',
    ],
    faq: [
      {
        question: 'Entrümpeln Sie auch im Nordbahnviertel?',
        answer: 'Ja, wir sind im gesamten 2. Bezirk tätig, einschließlich des modernen Nordbahnviertels.',
      },
      {
        question: 'Können Sie auch Garagen im Prater-Gebiet räumen?',
        answer: 'Selbstverständlich! Wir entrümpeln Garagen, Kellerboxen und Lagerräume im gesamten Bezirk.',
      },
      {
        question: 'Wie schnell können Sie kommen?',
        answer: 'Bei dringenden Fällen können wir oft innerhalb von 24-48 Stunden einen Termin anbieten.',
      },
    ],
  },
    ...
    faq: [
      {
        ...
        answer: 'Wir arbeiten äußerst diskret, nutzen neutrale Fahrzeuge und halten uns strikt an vereinbarte Zeiten.',
      },
      {
        question: 'Können Sie Wertgegenstände sicher handhaben?',
        answer: 'Ja, wir gehen sorgfältig mit allen Gegenständen um und können Wertgegenstände nach Wunsch separat behandeln.',
      },
      {
        question: 'Arbeiten Sie auch am Wochenende?',
        answer: 'Ja, wir bieten flexible Termine auch am Wochenende an.',
      },
    ],
  },
  '1040-wien-wieden': {
    ...
    whyChooseUs: [
      ...
      'Kenntnis der engen Stiegenhäuser',
    ...
    faq: [
      {
        ...
        answer: 'Ja, unsere Teams sind erfahren im Tragen über Stiegen, auch in hohen Stockwerken.',
      },
      {
        question: 'Was kostet eine Entrümpelung im 4. Bezirk?',
        answer: 'Die Kosten hängen vom Umfang ab. Nach einer kostenlosen Besichtigung erhalten Sie einen fairen Fixpreis.',
      },
      {
        question: 'Wie lange dauert eine Wohnungsentrümpelung?',
        answer: 'Eine durchschnittliche Wohnung entrümpeln wir in 4-6 Stunden.',
      },
    ],
  },
